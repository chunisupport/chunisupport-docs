...
<CardGrid>
  ...
  <LinkCard href="#reiwa互換api-compatreiwa1" title="reiwa互換API" description="reiwa互換形式の楽曲・譜面データを取得します。" />
</CardGrid>
...
reiwa互換APIは、[reiwa.f5.si（音ゲーツール置き場）](https://reiwa.f5.si/) が提供するAPIとの互換性を持つエンドポイントです。APIトークン認証を使用します。
