...
| フィールド | 型 | 説明 |
| ---------- | -- | ---- |
| `display_id` | string | コースの表示用ID（16文字の小文字16進数） |
| `idx` | string | 公式ID |
| `name` | string | コース名 |
...
| `courses[].display_id` | string | コースの表示用ID（16文字の小文字16進数） |
...
| パラメータ | 型 | 説明 |
| ---------- | -- | ---- |
| `displayid` | string | コースの表示用ID（16文字の小文字16進数） |
...
| コード | HTTP | 説明 |
| ------ | ---- | ---- |
| `validation_failed` | 422 | `displayid` の形式が不正です |
